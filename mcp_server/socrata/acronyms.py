...
SUPERINTENDENCIAS: Final[list[dict]] = [
    ...
    _entry(
        ...
        [
            ...
            "Vigilancia de Servicios Públicos",
        ],
        "superintendencia",
    ),
    _entry(
...
OTROS: Final[list[dict]] = [
    ...
    _entry(
        ...
        [
            "FIDUAGRARIA",
            "Fiduciaria Agropecuaria",
            "Fiduagraria Colombia",
